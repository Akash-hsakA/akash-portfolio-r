...
const MENU_ITEMS = [
  { label: "/ joker", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "/" },
  { label: "/ coding", image: "/assets/cards-menu/PNG/a-spade-menu-icon.png", href: "/coding" },
  { label: "/ system32", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "" },
  { label: "/ h4ck3r", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "" },
  { label: "/ contact", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "" },
  { label: "/ blog", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "" },
  { label: "/ gallery", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "" },
  { label: "/ resume", image: "/assets/cards-menu/PNG/joker-menu-icon.png", href: "" },
];
...
export default function ScreenMenu({ isOpen, onClose }: MenuProps) {
  ...
  useGSAP(() => {
    ...
    if (isOpen) {
      ...
      tl.to(containerRef.current, {
        clipPath: "circle(150% at calc(100% - 0.5dvw) 0.5dvw)",
        duration: 1,
        ease: "power3.inOut",
        pointerEvents: "auto",
      });
      ...
      tl.to(containerRef.current, {
        clipPath: "circle(0% at calc(100% - 0.5dvw) 0.5dvw)",
        duration: 0.8,
        ease: "power3.inOut",
        pointerEvents: "none",
      });
  ...
  return (
    <div
      className="position-continer"
      ref={containerRef}
      style={{ clipPath: "circle(0% at calc(100% - 5rem) 7rem)", pointerEvents: "none" }}
    >
      <div className="full-screen-menu-continer">
        {/* CLOSE BUTTON */}
