...
const MENU_LINKS = [
  ...
  { label: "cards", href: "", isExternal: false },
      ...
      <nav className="nav-content">
        ...
        <div className="nav-footer">
          <div className="social-group">
            <Link href="https://www.instagram.com/ezra_advik?igsh=MXNnNjg1bTh4NHp5dw==" target="_blank">
            ...
            <Link href="https://www.linkedin.com/in/akash-r-2a6a2423a/" target="_blank">
              <svg className="social-icon-svg" viewBox="0 0 24 24">
